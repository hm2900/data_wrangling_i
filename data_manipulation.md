...
Select columns from “gd0_weight” to “gd_of birth”.
...
Double equal to compare values.
...
Create a new variable and modify a existing variable.
...
litters_mutated = mutate(
  litters_data_selected, wt_gain = gd18_weight - gd0_weight)
